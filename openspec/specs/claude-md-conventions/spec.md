# Capability: CLAUDE.md Conventions

## Purpose

Documents the coding conventions, patterns, and idioms enforced across the codebase and captured in CLAUDE.md for AI-assisted development guidance.
